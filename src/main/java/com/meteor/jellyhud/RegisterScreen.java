...
public class RegisterScreen extends Screen {
    private static final Component ENTER_IP_LABEL = new TextComponent("请输入你的密码");
    ...
    public RegisterScreen(Screen p_95960_, BooleanConsumer p_95961_, ServerData p_95962_) {
        super(new TextComponent("登录 | 注册"));
    ...
    protected void init() {
        ...
        this.selectButton = this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 96 + 12, 200, 20,
                new TextComponent("开始冒险"), (p_95981_) -> {
            this.onSelect();
        }));
        this.addRenderableWidget(new Button(this.width / 2 - 100, this.height / 4 + 120 + 12, 200, 20,
                new TextComponent("返回主界面"), (p_95977_) -> {
    ...
    private void updateSelectButtonStatus() {
        ...
        AutoLogin.password = this.ipEdit.getValue();
    }
